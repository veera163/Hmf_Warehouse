package hmf.com.project.hmfwarehouse;
...
import hmf.com.project.hmfwarehouse.logger.L;
...
public class ESurvey extends Application {
   ...
   // public static final String URL = "http://192.168.0.105:9090";
    ...
    public static String getWAREHOUSEID() {
        return preference.getString(WAREHOUSEID, "NA");
    }

    public static String getWAREHOUSENAME() {
        return preference.getString(WAREHOUSENAME, "NA");    }
    ...
    public static String getIMAGEURL() {
        return preference.getString(IMAGEURL, "NA");
    }

    public static String getTYPE() {
        return preference.getString(TYPE, "NA");
    }

    public static String getFIRSTNAME(){

        return preference.getString(FIRSTNAME, "NA");
    }
    ...
    public static void saveImage(String photoUrl) {

        editor.putString(IMAGEURL,photoUrl);
        editor.commit();

    }
    public static void setUserInfo(String type, String firstName, String warehouseId, String warehouseName) {

        editor.putString(TYPE,type);
        editor.putString(FIRSTNAME,firstName);
        editor.putString(WAREHOUSEID,warehouseId);
        editor.putString(WAREHOUSENAME,warehouseName);
        editor.commit();
