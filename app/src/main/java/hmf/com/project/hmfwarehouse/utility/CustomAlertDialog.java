package hmf.com.project.hmfcustomer.utility;
...
public class CustomAlertDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = getActivity().getLayoutInflater().inflate(hmf.com.project.hmfcustomer.R.layout.alertdialog, null);
    ...
    private void initViewController(View view) {
        tv_message = (TextView) view.findViewById(hmf.com.project.hmfcustomer.R.id.tv_message);
        tv_tittle = (TextView) view.findViewById(hmf.com.project.hmfcustomer.R.id.tv_tittle);
    }
